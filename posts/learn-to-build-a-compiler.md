...
In my eyes understanding how a compiler works front to back can help anyone in computer science discover and learn about so many interesting fields of computer science. Not only that, but it can expand your practical skills by forcing you to understand what's actually happening under the hood of almost any language you write in. This class used to be required at my university but was removed for some reason completely unknown to me. I sincerely hope that it gets reinstated as a required class because its usefulness and ability to incorporate so many subfields of CS is incredibly valuable to me.
